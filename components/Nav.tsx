  ...
  return (
    <header className="px-8 py-6 flex items-center justify-between border-b border-[var(--border)]">
      ...
      <nav className="flex gap-8 text-sm tracking-widest uppercase">
        ...
        <Link href="/science" className="hover:text-turquoise active:text-turquoise transition-colors">
          Science
        </Link>
        <Link href="/about" className="hover:text-turquoise active:text-turquoise transition-colors">
          About
        </Link>
      </nav>
    </header>
